...
class CampanaTest {
    ...
    void setup() {
        ...
        entidad.setRazonSocial("Salud Total");
        entidad.setDireccion("Cra 123");
        entidad.setTelefono("3123123123");
        entidad.setCorreo("saludtotal@gmail.com");
        ...
        when(entidadRepository.save(any(EntidadSalud.class))).thenReturn(entidad);
        when(localizacionRepository.save(any(Localizacion.class))).thenReturn(localizacion);
        ...
        // Inicializar CampanaDTO y Campana
        campanaValida = crearCampanaBase();
        campanaEntidad = new Campana();
        campanaEntidad.setId(1L);
        campanaEntidad.setNombre(campanaValida.getNombre());
        campanaEntidad.setDescripcion(campanaValida.getDescripcion());
        campanaEntidad.setEntidadId(campanaValida.getEntidadId());
        campanaEntidad.setFechaInicio(campanaValida.getFechaInicio());
        campanaEntidad.setFechaLimiteInscripcion(campanaValida.getFechaLimiteInscripcion());
        campanaEntidad.setFechaLimite(campanaValida.getFechaLimite());
        campanaEntidad.setMinParticipantes(campanaValida.getMinParticipantes());
        campanaEntidad.setMaxParticipantes(campanaValida.getMaxParticipantes());
        campanaEntidad.setLocalizacionId(campanaValida.getLocalizacionId());
        campanaEntidad.setEstado(campanaValida.getEstado());
    }
