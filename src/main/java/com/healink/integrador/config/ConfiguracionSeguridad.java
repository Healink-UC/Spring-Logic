    ...
    public SecurityFilterChain filtroEncadenadoSeguridad(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers(new AntPathRequestMatcher("/api/n8n/**")).permitAll()
                        .requestMatchers(new AntPathRequestMatcher("/api/seguimientos/procesar-resultado")).permitAll()
                        .requestMatchers(new AntPathRequestMatcher("/api/test/n8n/**")).permitAll()
