...
public class AtencionMedicaController extends ControladorGenerico<AtencionMedica, AtencionMedicaDTO> {
     ...
     */
    @PutMapping("/{id}")
    @Operation(summary = "Actualizar atención médica parcialmente", 
    ...
    public ResponseEntity<AtencionMedicaDTO> actualizar(@PathVariable Long id, @RequestBody AtencionMedicaDTO dto) {
        ...
        try {
            ...
            Timestamp fechaInicio = dto.getFechaHoraInicio() != null ? dto.getFechaHoraInicio() : existingEntity.getFechaHoraInicio();
            Timestamp fechaFin = dto.getFechaHoraFin() != null ? dto.getFechaHoraFin() : existingEntity.getFechaHoraFin();
