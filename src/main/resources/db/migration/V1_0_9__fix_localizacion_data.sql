-- Limpiar y reinsertar datos de localización
TRUNCATE TABLE LOCALIZACION RESTART IDENTITY CASCADE;

-- Reinsertar datos con el formato correcto
INSERT INTO LOCALIZACION (departamento, municipio, vereda, localidad, latitud, longitud)
VALUES 
    -- Manizales - Zona Norte
